...
//    })?;
//    let rsp_struct: rsp::GetCyclicParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}
...
//    })?;
//    let rsp_struct: rsp::GetSinusoidParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}
...
//    })?;
//    let rsp_struct: rsp::GetConstantParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}
...
//    })?;
//    let rsp_struct: rsp::GetSquareWaveParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}
...
//    })?;
//    let rsp_struct: rsp::GetLinearSweepParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}
...
//    })?;
//    let rsp_struct: rsp::GetChronoampParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}

//pub fn get_multistep_param(&mut self) -> anyhow::Result<param::MultistepParam> {
//    let cmd_json = serde_json::to_value(&cmd::GetParam {
//        command: constant::GET_PARAM_STR,
//        test: constant::MULTISTEP_TEST_STR,
//    })?;
//    let rsp_struct: rsp::GetMultistepParam = self.write_json_read_rsp(&cmd_json)?;
//    Ok(rsp_struct.response.param)
//}
